...
const KanbanColumn = ({
  ...
  return (
    <div
      ref={setNodeRef}
      className="flex h-full min-w-[280px] flex-col rounded-3xl border border-slate-200/80 bg-white/80 p-4 shadow-sm backdrop-blur transition-colors hover:border-slate-300 snap-start"
    >
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="rounded-full border border-slate-200 bg-white px-2 py-0.5 text-xs text-slate-500 transition hover:border-slate-300 hover:text-slate-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-300"
          >
            + Ajouter
          </button>
          <button
          ...
          <button
            ...
            className="rounded-full border border-rose-200 bg-white px-2 py-0.5 text-xs text-rose-600 transition hover:border-rose-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-200"
          >
            Supprimer
          </button>
        </div>
