  ...
  return (
    <div className="rounded-3xl border border-slate-200 bg-white p-8 dark:border-slate-800 dark:bg-slate-900">
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-2">
        ...
        <div>
          ...
          <div className="mt-2 flex items-center gap-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-slate-200 bg-slate-50 text-2xl dark:border-slate-700 dark:bg-slate-800">
              {emoji}
            </div>
      ...
      <div className="mt-6 flex items-center gap-2">
        <button
          type="button"
          onClick={() => saveSettings({ displayName: name.trim(), avatarEmoji: emoji })}
